...
class Fx extends dn.Process {
    ...
    public function flashBangS(c: UInt, a: Float, ?t = 0.1) {
        ...
        game.root.add(e, Const.TOP_FX_LAYER);
        e.scaleX = game.w();
        e.scaleY = game.h();
        e.blendMode = Add;
